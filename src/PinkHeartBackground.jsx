...
export default function PinkHeartBackground({ children }) {
  ...
  return (
    <>
      {/* ✅ Fixed background — stays behind everything, never affects layout/scroll */}
      <div className="fixed inset-0 bg-gradient-to-br from-pink-100 via-rose-100 to-pink-200 -z-10">
        {/* Floating hearts */}
        ...
        {/* Depth overlay */}
        <div className="absolute inset-0 bg-gradient-to-b from-transparent via-pink-50/30 to-rose-200/40 pointer-events-none" />
      ...
      {/* ✅ Scrollable content wrapper — sits on top of the fixed background */}
      ...
      <style>{`
        @keyframes float-drift {
          ...
          25%  { transform: translate(10px, -30px) rotate(5deg) scale(1.05); }
          50%  { transform: translate(-5px, -60px) rotate(-3deg) scale(1); }
